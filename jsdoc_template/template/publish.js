...
var navOptions = {
  ...
  logoFile: conf.logoFile,
    ...
    systemTitle: conf.systemTitle || "Documentation",
...
function tutoriallinkBoostrap(tutorial) {
...
function hashToLink(doclet, hash,classCss) {
  if (!/^(#.+)/.test(hash)) {
    return hash;
  }

  var url = helper.createLink(doclet);
  var classCssStr = classCss ? "class='"+ classCss +"'":"";
  url = url.replace(/(#.+|$)/, hash);
  return '<a href="' + url + '" " + classCssStr + ">' + hash + '</a>';
}
...
function buildNav(members) {
  ...
  if (members.modules.length) {
    ...
    members.modules.forEach(function(m) {
      if (!hasOwnProp.call(seen, m.longname)) {
        ...
        nav.module.members.push(linkto(m.longname, m.longname.replace("module:", ""),"dropdown-item"));
      }
  ...
  if (members.externals.length) {
    ...
    members.externals.forEach(function(e) {
      if (!hasOwnProp.call(seen, e.longname)) {
        ...
        nav.external.members.push(linkto(e.longname, e.name.replace(/(^"|"$)/g, ''),"dropdown-item"));
      }
  ...
  if (members.classes.length) {
    ...
    members.classes.forEach(function(c) {
      if (!hasOwnProp.call(seen, c.longname)) {
        ...
        nav.class.members.push(linkto(c.longname, c.longname.replace("module:", ""),"dropdown-item"));
      }
  ...
  if (members.events.length) {
    ...
    members.events.forEach(function(e) {
      if (!hasOwnProp.call(seen, e.longname)) {
        ...
        nav.event.members.push(linkto(e.longname, e.longname.replace("module:", ""),"dropdown-item"));
      }
      seen[e.longname] = true;
    });
  ...
  if (members.namespaces.length) {
    ...
    members.namespaces.forEach(function(n) {
      if (!hasOwnProp.call(seen, n.longname)) {
        ...
        nav.namespace.members.push(linkto(n.longname, n.longname.replace("module:", ""),"dropdown-item"));
      }
  ...
  if (members.mixins.length) {
    ...
    members.mixins.forEach(function(m) {
      if (!hasOwnProp.call(seen, m.longname)) {
        ...
        nav.mixin.members.push(linkto(m.longname, m.longname.replace("module:", ""),"dropdown-item"));
      }
      seen[m.longname] = true;
    });
  ...
  if (members.interfaces && members.interfaces.length) {
    ...
    members.interfaces.forEach(function(m) {
      if (!hasOwnProp.call(seen, m.longname)) {
        ...
        nav.interface.members.push(linkto(m.longname, m.longname.replace("module:", ""),"dropdown-item"));
      }
      seen[m.longname] = true;
    });
  ...
  if (members.tutorials.length) {
    ...
    members.tutorials.forEach(function(t) {
       ...
       nav.tutorial.members.push(
           "<a href='tutorial-"+t.name+".html' class='dropdown-item'>"+t.title+"</a>"
       );
       //nav.interface.members.push(linkto(t.longname,t.name,"dropdown-item"));
    });
  ...
  if (members.globals.length) {
    members.globals.forEach(function(g) {
      if (g.kind !== 'typedef' && !hasOwnProp.call(seen, g.longname)) {
        ...
        nav.global.members.push(linkto(g.longname, g.longname.replace("module:", ""),"dropdown-item"));
      }
    ...
    if (nav.global.members.length === 0) {
      nav.global.members.push(linkto("global", "Global","dropdown-item"));
    }
  }
...
exports.publish = function(taffyData, opts, tutorials) {
  ...
  view_tutorial = new template.Template(templatePath + '/tmpl');
  ...
  //ADAPT TUTORIAL
    view_tutorial.layout= conf['default'].layoutFile ?
        path.getResourcePath(path.dirname(conf['default'].layoutFile),
            path.basename(conf['default'].layoutFile) ) : 'layout_tutorial.tmpl';
  ...
  // add template helpers
    ...
    view_tutorial.find = find;
    view_tutorial.linkto = linkto;
    view_tutorial.resolveAuthorLinks = resolveAuthorLinks;
    view_tutorial.tutoriallink = tutoriallink;
    view_tutorial.htmlsafe = htmlsafe;
    view_tutorial.moment = moment;
  ...
  view.navOptions = navOptions;
    ...
    view_tutorial.nav = navigationMaster;
    view_tutorial.navOptions = navOptions;
  ...
  function generateTutorial(title, tutorial, filename) {
    ...
    var tutorialPath = path.join(outdir, filename),
      html = view_tutorial.render('tutorial.tmpl', tutorialData);
